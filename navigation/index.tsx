  ...
  return (
    <Stack.Navigator>
      ...
      <Stack.Group screenOptions={{ presentation: 'modal' }}>
        <Stack.Screen name="AnimalRecord" component={MedicalRecordScreen}  options={{ title: 'Dossier médical' }} />
      </Stack.Group>
    </Stack.Navigator>
  );
};
  ...
  return (
    <BottomTab.Navigator
      ...
      <BottomTab.Screen
        ...
        options={() => ({
          title: 'Mes Animaux',
          tabBarIcon: ({ color }) => <FontAwesome5 size={25} style={{ marginBottom: -3 }} color={color} name="paw" />
        })}
      />
      <BottomTab.Screen
        name="Meeting"
